...
public class VisitanteFacadeImp
    extends BaseFacadeImpl<Visitante, VisitanteDto, VisitanteCreateDto, VisitanteCreateDto, Long> {
  public VisitanteFacadeImp(BaseService<Visitante, Long> baseService,
